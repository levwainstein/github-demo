...
import { isReviewWorkItem } from '../../types/work';
...
const Work: FunctionComponent<Props> = ({}: Props) => {
    ...
    useEffect(() => {
        // Temporary fix as new work page does not support community review work
        // TODO remove when new work page shows community review component for accepting/requesting modifications after accept
        if (work && isReviewWorkItem(work.workType)) {
            history.push({
                pathname: '/',
