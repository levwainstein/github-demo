...
const Github: FunctionComponent<Props> = ({
    color_start = Colors.lightningYellow,
    color_stop = Colors.pirateGold
}: Props) => {
    return (
        <svg
            width="20"
        ...
        >
            <path
                ...
                fill="url(#paint0_linear_1_6109)"
            />
            <defs>
                <linearGradient
                    id="paint0_linear_1_6109"
                    x1="0"
                    y1="0"
                    x2="23.6055"
                    y2="6.58822"
                ...
                >
                    <stop stopColor={color_start} />
                    <stop offset="1" stopColor={color_stop} />
                </linearGradient>
            </defs>
        </svg>
    );
